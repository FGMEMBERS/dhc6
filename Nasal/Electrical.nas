...
electrical_bus = func(bv) {
    ...
    if (getprop("engines/engine[0]/n2") >= 12 and internal_condition0 > 0 and fuel_rich0 < 25 and fwd_boost != 0 and if_engine0_serviceable and if_engine0_cutoff==0) {
       setprop("controls/engines/engine[0]/internal-condition", internal_condition0);
    } else {
       setprop("controls/engines/engine[0]/internal-condition", 0);
    }

    if (getprop("engines/engine[1]/n2") >= 12 and internal_condition1 > 0 and fuel_rich1 < 25 and aft_boost != 0  and if_engine1_serviceable and if_engine1_cutoff==0) {
       setprop("controls/engines/engine[1]/internal-condition", internal_condition1);
    } else {
